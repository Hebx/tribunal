    ...
    <div className="animate-fade-up py-2">
      <div className="mb-6">
        ...
        <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-text-muted">
          Pose a genuinely contestable yes/no question. The committee deliberates, then the case is
          opened on Sui — config hash-locked, verdict asserted with a bond, and the dispute window
